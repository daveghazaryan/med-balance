...
function mediaGallery(e) {
    ...
    var u, p, f, h, m, g, v = navigator.userAgent || navigator.vendor || window.opera, y = $("#" + e), w = $("#" + e + " .js-gallery-panel-card"), b = $("#" + e + " .js-gallery-panel-card__media-container"), j = $("#" + e + " .js-gallery-panel-card__nav--prev > a"), _ = $("#" + e + " .js-gallery-panel-card__nav--next > a"), C = $("#" + e + " .js-gallery-panel__current-card-number"), x = $("#" + e + " .js-gallery__button--popout"), k = 48, T = 48, S = window.location.protocol;
...
"undefined" != typeof module && module.exports && (module.exports = Hogan),
    function(e) {
        ...
        var t, n, i, a, s, o, r = "Close", l = "BeforeClose", c = "MarkupParse", d = "Open", u = "Change", p = "mfp", f = "." + p, h = "mfp-ready", m = "mfp-removing", g = "mfp-prevent-close", v = function() {}, y = !!window.jQuery, w = e(window), b = function(e, n) {
            t.ev.on(p + e + f, n)
        }, j = function(t, n, i, a) {
        ...
        v.prototype = {
            ...
            e.fn.magnificPopup = function(n) {
                ...
                if ("string" == typeof n)
                    if ("open" === n) {
                        var a, s = y ? i.data("magnificPopup") : i[0].magnificPopup, o = parseInt(arguments[1], 10) || 0;
        ...
        e.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                ...
                preloadNearbyImages: function() {
                    var e, n = t.st.gallery.preload, i = Math.min(n[0], t.items.length), a = Math.min(n[1], t.items.length);
    ...
    function() {
        ...
        i && i.addEventListener("click", function(t) {
            e.classList.add("hide"),
                document.cookie = notificationBannerCookieName + "=closed; path=/; SameSite=Lax; max-age=86400"
        }),
